...
;;; Flyspell mode
;;;
(dolist (hook '(enh-ruby-mode-hook ruby-mode-hook markdown-mode-hook haml-mode-hook javascript-mode))
...
;;; indent magic
;;;
(dolist (hook '(enh-ruby-mode-hook ruby-mode-hook markdown-mode-hook javascript-mode))
